...
SPARK_INSTANCE_ID = "9f501913-9653-4cbb-91f0-f0c33f9f7137" 
USER = "blueinfo_os_1"
PASSWORD = "HYnKZdW2BHCksMDpAgKs"
...
def send_msg_to_telegram(msg):
    bot_id = "8070825758:AAEK2R020rrGv2kaC0S3AFMP8_lkFhYbvvg" # update theo bot moi nhat
...
def run_flow(**kwargs):
    ...
    # upt 
    update_id = call_api_run_code(access_token, spark_instance_id, "bli_release/src/tools/auto_upd.py", arguments, config_type)
    logger.info("upt")
...
with DAG(
    ...
    input_arg = "--dt_from {{params.dt_from}} --dt_to {{params.dt_to}} --run_mode {{params.run_mode}}"
