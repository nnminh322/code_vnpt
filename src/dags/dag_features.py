...
def call_api_run_code(access_token, spark_instance_id, python_file, start_time, arguments, config_type="small"):
    arguments += f" --dag_name {DAG_NAME}"
    arguments += f" --python_file {python_file.replace('.py', '').replace('/', '__')}"
    arguments += f" --start_time {start_time}"
...
def run_flow(**kwargs):
    ...
    dag_start_time = dag_run.start_date + timedelta(hours=7)
    start_time = dag_start_time.strftime("%Y%m%d%H%M%S")

    # upt 
    update_id = call_api_run_code(access_token, spark_instance_id, "bli_release/src/tools/auto_upd.py", start_time, arguments, 'tiny')
    logger.info("upt")

    # send request
    job_id = call_api_run_code(access_token, spark_instance_id, python_file, start_time, arguments, config_type)
...
with DAG(
    ...
    _3gsub_daily = create_operator(
        task_name = "_3gsub_daily",
        py_file = "bli_release/src/features/3gsub/3gsub_daily.py",
        config_type="small",
        exe_args = input_arg,
    )

    _3gsub_lxw = create_operator(
        task_name = "_3gsub_lxw",
        py_file = "bli_release/src/features/3gsub/3gsub_lxw.py",
        config_type="small",
        exe_args = input_arg,
    )

    air_lxw = create_operator(
        task_name = "air_lxw",
        py_file = "bli_release/src/features/air/air_lxw.py",
        config_type="small",
        exe_args = input_arg,
    )

    device_weekly = create_operator(
        task_name = "device_weekly",
        py_file = "bli_release/src/features/device/device_weekly.py",
        config_type="small",
        exe_args = input_arg,
    )  

    ggsn_daily = create_operator(
        task_name = "ggsn_daily",
        py_file = "bli_release/src/features/ggsn/ggsn_daily.py",
        config_type="medium",
        exe_args = input_arg,
    )

    ggsn_lxw = create_operator(
        task_name = "ggsn_lxw",
        py_file = "bli_release/src/features/ggsn/ggsn_lxw.py",
        config_type="small",
        exe_args = input_arg,
    )

    location_l4w = create_operator(
        task_name = "location_l4w",
        py_file = "bli_release/src/features/location/location_l4w.py",
        config_type="small",
        exe_args = input_arg,
    )
    
    money_transfer_lxw = create_operator(
        task_name = "money_transfer_lxw",
        py_file = "bli_release/src/features/money_transfer/money_transfer_lxw.py",
        config_type="small",
        exe_args = input_arg,
    )

    prepaid_danhba_weekly = create_operator(
        task_name = "prepaid_danhba_weekly",
        py_file = "bli_release/src/features/prepaid_danhba/prepaid_danhba_weekly.py",
        config_type="small",
        exe_args = input_arg,
    )

    udv_lxw = create_operator(
        task_name = "udv_lxw",
        py_file = "bli_release/src/features/udv/udv_lxw.py",
        config_type="small",
        exe_args = input_arg,
    )

    usage_daily = create_operator(
        task_name = "usage_daily",
        py_file = "bli_release/src/features/usage/usage_daily.py",
        config_type="small",
        exe_args = input_arg,
    )

    usage_lxw = create_operator(
        task_name = "usage_lxw",
        py_file = "bli_release/src/features/usage/usage_lxw.py",
        config_type="small",
        exe_args = input_arg,
    )

    utn_lxw = create_operator(
        task_name = "utn_lxw",
        py_file = "bli_release/src/features/utn/utn_lxw.py",
        config_type="small",
        exe_args = input_arg,
    )

    voice_daily = create_operator(
        task_name = "voice_daily",
        py_file = "bli_release/src/features/voice/voice_daily.py",
        config_type="small",
        exe_args = input_arg,
    )

    voice_lxw = create_operator(
        task_name = "voice_lxw",
        py_file = "bli_release/src/features/voice/voice_lxw.py",
        config_type="small",
        exe_args = input_arg,
    )
    
    volte_daily = create_operator(
        task_name = "volte_daily",
        py_file = "bli_release/src/features/volte/volte_daily.py",
        config_type="small",
        exe_args = input_arg,
    )

    volte_lxw = create_operator(
        task_name = "volte_lxw",
        py_file = "bli_release/src/features/volte/volte_lxw.py",
        config_type="small",
        exe_args = input_arg,
    )    

    ccbs_no_l1m = create_operator(
        task_name = "ccbs_no_l1m",
        py_file = "bli_release/src/features/ccbs_no/ccbs_no_l1m.py",
        config_type="small",
        exe_args = input_arg,
    )

    ccbs_tra_l1m = create_operator(
        task_name = "ccbs_tra_l1m",
        py_file = "bli_release/src/features/ccbs_tra/ccbs_tra_l1m.py",
        config_type="small",
        exe_args = input_arg,
    )

    sub_daily = create_operator(
        task_name = "sub_daily",
        py_file = "bli_release/src/features/sub/sub_daily.py",
        config_type="small",
        exe_args = input_arg,
    )

    sub_lxw = create_operator(
        task_name = "sub_lxw",
        py_file = "bli_release/src/features/sub/sub_lxw.py",
        config_type="small",
        exe_args = input_arg,
    )

    vascloud_daily = create_operator(
        task_name = "vascloud_daily",
        py_file = "bli_release/src/features/vascloud/vascloud_daily.py",
        config_type="small",
        exe_args = input_arg,
    )

    vascloud_lxw = create_operator(
        task_name = "vascloud_lxw",
        py_file = "bli_release/src/features/vascloud/vascloud_lxw.py",
        config_type="small",
        exe_args = input_arg,
    )

    tac_mapping_daily = create_operator(
        task_name = "tac_mapping_daily",
        py_file = "bli_release/src/features/tac_mapping/tac_mapping_daily.py",
        config_type="small",
        exe_args = input_arg,
    )

    tac_mapping_weekly = create_operator(
        task_name = "tac_mapping_weekly",
        py_file = "bli_release/src/features/tac_mapping/tac_mapping_weekly.py",
        config_type="small",
        exe_args = input_arg,
    )

    usageda_daily = create_operator(
        task_name = "usageda_daily",
        py_file = "bli_release/src/features/usageda/usageda_daily.py",
        config_type="small",
        exe_args = input_arg,
    )

    usageda_lxw = create_operator(
        task_name = "usageda_lxw",
        py_file = "bli_release/src/features/usageda/usageda_lxw.py",
        config_type="small",
        exe_args = input_arg,
    )

    brandname_lxw = create_operator(
        task_name = "brandname_lxw",
        py_file = "bli_release/src/features/brandname/brandname_lxw.py",
        config_type="small",
        exe_args = input_arg,
    )

    smrs_lxm = create_operator(
        task_name = "smrs_lxm",
        py_file = "bli_release/src/features/smrs/smrs_lxm.py",
        config_type="small",
        exe_args = input_arg,
    )
    
    dq_runner_raw = create_operator(
        task_name = "dq_runner_raw",
        py_file = "bli_release/src/data_quality/dq_runner_raw.py",
        config_type="medium",
        exe_args = input_arg,
    )

    dq_runner_features = create_operator(
        task_name = "dq_runner_features",
        py_file = "bli_release/src/data_quality/dq_runner_features.py",
        config_type="medium",
        exe_args = input_arg,
    )

    jq_tracer_event = create_operator(
        task_name = "jq_tracer_event",
        py_file = "bli_release/src/job_quality/jq_runner_features.py",
        config_type="small",
        exe_args = input_arg,
    )

    merge_node = DummyOperator(
        task_id = "merge"
    )

    final_node = DummyOperator(
        task_id = "final"
    )
    ...
    dq_runner_raw >> start_node

    start_node >> tac_mapping_daily >> ggsn_daily >> volte_daily >> air_lxw >> device_weekly >> location_l4w  >> money_transfer_lxw >> prepaid_danhba_weekly >> smrs_lxm >> merge_node
    start_node >> sub_daily >> usage_daily >> voice_daily >> ccbs_no_l1m >> ccbs_tra_l1m >> udv_lxw >> utn_lxw >> vascloud_daily >> usageda_daily >> brandname_lxw >> _3gsub_daily >> merge_node 

    merge_node >> volte_lxw >> ggsn_lxw >> tac_mapping_weekly >>  usageda_lxw >> _3gsub_lxw >> end_node
    merge_node >> usage_lxw >> voice_lxw >> sub_lxw >> vascloud_lxw >> end_node

    end_node >> jq_tracer_event >> dq_runner_features >> extract_config >> final_node

    
    ### define downstream dag
    downstream_dags = [
        'BLI_DAG_cs_v2_202505_tnex',
        'BLI_DAG_lg_v2_202505_baseline'
        ]
    ...
    for dag_id in downstream_dags: 
        trigger_dag = TriggerDagRunOperator(
            ...
            reset_dag_run = False,
            # conf = {"source" : "DAG_A"},
            conf = "{{ task_instance.xcom_pull(task_ids='extract_config', key='run_configs') }}",   
        )       
        lg_tasks.append(trigger_dag) if '_lg_' in dag_id else cs_tasks.append(trigger_dag)


    final_node >> lg_tasks[0] 
    final_node >> cs_tasks[0]

    for i in range((len(lg_tasks)) - 1): 
        lg_tasks[i] >> lg_tasks[i+1]

    for i in range((len(cs_tasks)) - 1): 
        cs_tasks[i] >> cs_tasks[i+1]
