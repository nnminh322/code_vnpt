...
DAG_NAME = "BLI_DAG_cs_v2_202505_mc"
SCHEDULE = '30 7 * * 1'
DAG_ARGS = {    
...
with DAG(
    ...
    cs_v2_202505_mc = create_operator(
        task_name = "cs_v2_202505_mc",
        py_file = "bli_release/src/models/cs_v2_202505_mc.py",
        config_type="huge",
        exe_args = input_arg,
    )
    ...
    start_node >> cs_v2_202505_mc >> end_node