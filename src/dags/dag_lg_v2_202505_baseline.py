...
DAG_NAME = "BLI_DAG_lg_v2_202505_baseline"
SCHEDULE = '30 7 * * 1'
DAG_ARGS = {    
...
with DAG(
    ...
    lg_v2_202505_baseline = create_operator(
        task_name = "lg_v2_202505_baseline",
        py_file = "bli_release/src/models/lg_v2_202505_baseline.py",
        config_type="small",
        exe_args = input_arg,
    )
    ...
    start_node >> lg_v2_202505_baseline >> end_node