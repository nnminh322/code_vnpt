...
def load_feature_by_month_and_merge(spark, table_name, feature_list, fix_date, ALL_MONTHS):
    ...
    for feature in feature_list:
        ...
        # df_columns_added_time = [f"`{x}` as `{x}_{month}`" iwf table_name in x else f"{x}" for x in df_columns]
...
feature_list = [
    ...
    'DATA_RMNG_USG',
    'TOT_VOICE_RVN_AMT',
    'TOT_VOICE_REFUND_AMT',
    'TOT_VOICE_DISC_AMT',
    'TOT_VOICE_ONNET_IC_RVN_AMT',
    'TOT_VOICE_ONNET_OG_RVN_AMT',
    'TOT_VOICE_OFFNET_IC_RVN_AMT',
    'TOT_VOICE_OFFNET_OG_RVN_AMT',
    'TOT_VOICE_ISD_OG_RVN_AMT',
    'TOT_VOICE_ISD_IC_RVN_AMT',
    'TOT_DATA_RVN_AMT',
    'TOT_DATA_REFUND_AMT',
    'TOT_DATA_CHRGD_AMT',
    'TOT_SMS_RVN_AMT',
    'TOT_SMS_REFUND_AMT',
    'TOT_SMS_ONNET_IC_RVN_AMT',
    'TOT_SMS_ONNET_OG_RVN_AMT'
]
